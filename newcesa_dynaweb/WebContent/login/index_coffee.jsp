...
pstmt = conn.prepareStatement("SELECT * FROM member_coffee Order by seq DESC LIMIT 1");
...
<script >
	function login() {
		...
		memberId.value = <%=memberid1%>+1;
		//alert(memberId.value);
		memberPasswd.value = 4;
...
<div style="width: 100%; padding: 0 0; text-align: center;">
	<img src="/img/front/top_logo_1.png" width="100%" />
</div>
<div style="width: 87.5%; padding: 0 6.25%; margin-top: 30px;">
	...
	<img src="/img/front/vi.png" style="width: 100%;" />
	<div style="padding-top: 28px;">
		<input type="image" onclick="login();" src="/img/front/start.png" style="width: 155px;">
	</div>
	<div style="width: 100%;">
		<form name="loginFrm" id="loginFrm" action="/login/loginProc_coffee.jsp"
			method="post">
