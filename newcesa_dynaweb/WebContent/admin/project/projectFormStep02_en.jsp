...
function goSaveAs(){
	...
	if ( isEmpty(f.newProjectName.value)) {
		alert("Please enter a new name to save the project.");
...
function showResponse(responseText, statusText, xhr, $form)  { 
	if(responseText.result == "success"){
		...
		alert("Failed. Check the Excel file.");
	}
}
...
<div id="form_warp">
	<dl>
		<dt class="inpt_dt">Activity Upload</dt>
		<dd class="inpt_dd">
			<form name="activityFileForm" id="activityFileForm" action="projectActivityUpload.jsp" method="post" enctype="multipart/form-data">
				<input type="file" id="filename" name="filename" value="" size="15"/> <input type="submit" class="button blue" value="Upload" style="width:50px"/>
				&nbsp;&nbsp;&nbsp;<input type="button" class="button white" value="sample download" style="width:120px" onclick='sampleDownload()'/>
			</form>
		</dd>
...
<div class="btn_group_left_align" style="float: right">
	<input  type="button" onclick="addCol('');" value="Activity Add" class="button blue" />
</div>
<br>
<br>
<br>
...
<div class="btn_group_right_align">
	...
	<input type="button" onclick="goSaveAs();" value="Save as" class="button red" style="width:130px;" />
