...
%>
	<script>
		if(<%=resultSBP%>) {
			alert("등록 되었습니다.");
			location.href="projectFormStep02.jsp?seq=" + <%=seq%>;
		}
	</script>
...
%>
	<script>
		if(<%=resultSBP%>) {
			alert("SBP연결이 해제 되었습니다.");
			location.href="projectFormStep02.jsp?seq=" + <%=project_seq%>;
		}
	</script>
...
%>
	<script>
		if(<%=resultSBP%>) {
			alert("SBP프로젝트 연결이 해제 되었습니다.");
			location.href="projectFormStep02.jsp?seq=" + <%=project_seq2%>;
		}
	</script>
