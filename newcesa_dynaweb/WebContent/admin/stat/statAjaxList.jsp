...
<%
	...
	try {
		...
		sbufTable.append("<input type=\"button\" onclick=\"changeChart('curve_chart');\" value=\"선택 어휘\" class=\"button white\" style=\"width:80px;\" />&nbsp;&nbsp;");
		sbufTable.append("<input type=\"button\" onclick=\"changeChart('all_chart');\" value=\"모든 어휘\" class=\"button white\" style=\"width:80px;\" />&nbsp;&nbsp;");
