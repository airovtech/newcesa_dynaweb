...
<div class="top_title">ExperienceVocabulary Group Management</div>
...
<div class="btn_group_right_align">
	<input type="button" onclick="document.location.href='groupForm_en.jsp'" value="Add" class="button white" style="width:33px;"/>
</div>
