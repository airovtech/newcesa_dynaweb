...
<div class="btn_group_right_align">
	<input type="button" onclick="document.location.href='groupList.jsp'" value="취소" class="button white" style="width:50px;" />

	<input type="button" onclick="goSubmit();" value="저장" class="button black" style="width:50px;" />
	<input type="button" onclick="goCopy();" value="복사" class="button black" style="width:50px;" />
</div>
