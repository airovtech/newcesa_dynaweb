...
function goSubmit(){
	...
	if ( isEmpty(f.word.value)) {
		...
		alert("Please vocabulary redundancy check.");
		return;
	}else if(f.checkWord.value == "1"){
...
<table cellspacing='0' cellpadding='0' class='layerTable' width=100%>
	<tr>
		<th colspan=2>Vocabulary <%="".equals(seq) ? "Registration" : "Revise"%></th>
	</tr>
	<tr>
		<td width=20%; style="text-align:center">Vocabulary</td>
		<td><input type="text" name="word" id="word" value="" maxlength="20" />
			<input type="button" onclick="duplCheck(word)" value="Duplicate Check" class="button white" />
		</td>
	</tr>
</table>
...
<div style="width:100%; text-align:center; margin-top:5px;">
	...
	<input type="button" onclick="window.close();" value="close" class="button white" style="width:50px;" />
</div>
</div>
				</div>
			</div><!-- content 끝 -->
