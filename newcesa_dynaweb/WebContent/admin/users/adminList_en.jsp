...
<div class="top_title">Administrator Management</div>
...
<div id="roof_table">
	<table cellspacing="0" cellpadding="0" width="900px">
		...
		<tr>
			...
			<td class="ta_c"><a href="adminForm_en.jsp?seq=<%=cRowSet.getString("seq")%>"><%=cRowSet.getString("adminID")%></a></td>
			...
			<td class="ta_c"><input type="button" onclick="goDelete('<%=cRowSet.getString("seq")%>')" value="Delete" class="button black" style="width:45px;"/></td>
		</tr>
		<%
			}
		}
...
<div style="width:100%; text-align:center; margin-top:20px;">
    <dnt7:page pageCommonUrl='adminList_en.jsp' totCount='<%=totalCount%>' currPage='<%=currPage%>' serviceType='admin'/>
</div>
<div class="btn_group_right_align">
	<input type="button" onclick="document.location.href='adminForm_en.jsp'" value="Add" class="button white" style="width:33px;"/>
</div>
